defmodule Web3XLiveview.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Web3XLiveview.Repo)
  ...
  """
  def valid_password?(%Web3XLiveview.Accounts.User{hashed_password: hashed_password}, password)
